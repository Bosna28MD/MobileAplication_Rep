...
public class notificationRecycleViewAdapter extends   RecyclerView.Adapter<notificationRecycleViewAdapter.ViewHolder> {
    ...
    Context context;
    ArrayList<UserData> notificationArr;
    NotificationFragment notificationFragment;

    public notificationRecycleViewAdapter(Context context,NotificationFragment notificationFragment) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_notificationlist_recycleview,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.txtEmail.setText(String.valueOf(notificationArr.get(position).getEmail()));
        holder.txtName.setText(String.valueOf(notificationArr.get(position).getUsername()));
        ...
        holder.btnAccept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url ="http://192.168.0.53/FinalProject_Android/btnNotificationAccept.php";
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                if(response.equals("success")){
                                    ...
                                    notificationArr.remove(position);
                                    notificationFragment.getRecyclerViewNotification().setAdapter(notificationRecycleViewAdapter.this);
    ...
    public int getItemCount() {
        return notificationArr.size();
    }

    public void setNotificationArr(ArrayList<UserData> notificationArr) {
